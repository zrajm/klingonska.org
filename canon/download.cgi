...
<TABLE BORDER=0 CELLPADDING=0 CELLSPACING=0 WIDTH=100% ALIGN=CENTER>
  <TR>
    ...
    <TD ALIGN=RIGHT><I><FONT SIZE=1><A HREF="http://klingonska.org/canon/download.cgi">http://klingonska.org/canon/download.cgi</A></FONT></I></TD>
  </TR>
</TABLE>

<!-- ==================== Titel ==================== -->
<P ALIGN=CENTER><A HREF="http://klingonska.org/"><IMG SRC="/pic/ka.gif" WIDTH="600" HEIGHT="176" ALT="Klingonska Akademien" BORDER=0 VSPACE=5></A>

<H1 ALIGN=CENTER>Klingon Data Download.</H1>

<H2>Authourization request.</H2>
...
<INPUT TYPE=HIDDEN NAME="prev" VALUE="http://klingonska.org/">
<INPUT TYPE=HIDDEN NAME="question" VALUE=13>
<INPUT TYPE=HIDDEN NAME="file" VALUE="">

<H3>TKD, page 24, paragraph 3, line 1, word 1:</H3>

<P><INPUT NAME="answer" VALUE="">
