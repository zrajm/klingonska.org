...
<HTML><HEAD><TITLE>Klingonska Akademien - The pIqaD Playground.
</TITLE></HEAD>
...
<center>
<p><form action="play.cgi" method=post>
Type something in Klingon below to see it written in <b>pIqaD</b>.
<br><textarea name=text rows=11 cols=40>
